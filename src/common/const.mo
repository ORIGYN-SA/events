module {
  ...
  public let QUEUE_OVERFLOWS_PROCESS_INTERVAL = 180_000_000_000:Nat64; // 3 * 60 * 1_000_000_000

  public let QUEUE_OVERFLOWS_CLEAR_INTERVAL = 600_000_000_000:Nat64; // 10 * 60 * 1_000_000_000
  ...
  public let QUEUE_OVERFLOW_THRESHOLD = 200;
