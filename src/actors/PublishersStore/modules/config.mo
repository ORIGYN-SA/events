...
module {
  ...
  public type BroadcastIdsFullParams = (caller: Principal, state: State.PublishersStoreState, params: BroadcastIdsParams);
  ...
  public type CanisterMetricsFullParams = (caller: Principal, state: State.PublishersStoreState, params: CanisterMetricsParams);
